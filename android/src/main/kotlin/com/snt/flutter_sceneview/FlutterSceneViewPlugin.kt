package com.snt.flutter_sceneview
...
import com.snt.flutter_sceneview.handlers.PermissionsHandler
import com.snt.flutter_sceneview.factory.ScenePlatformViewFactory
...
class FlutterSceneViewPlugin : FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        try {
            channel = MethodChannel(flutterPluginBinding.binaryMessenger, Channels.Companion.MAIN)
        ...
        try {
            ...
            permissionsHandler?.checkAndRequestPermission { granted ->
                if (granted) {
                    ...
                    if (!isViewRegistered) {
                        val viewTypeId = Channels.Companion.VIEW
